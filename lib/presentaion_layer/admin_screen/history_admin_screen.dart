...
class _HistoryAdminScreenState extends State<HistoryAdminScreen> {
  ...
  void initState() {
    Future.delayed(Duration.zero,()async{
      await _userController.getAllHistory();
    });
    super.initState();
  }
                ...
                fallback: (context){
                  if(_userController.historyAdminModel.isEmpty){
                    ...
                    return ListView.separated(
                        ...
                        itemBuilder: (context,index)=>buildHistoryItem(_userController.historyAdminModel[index]),
                        separatorBuilder: (context,index)=>const SizedBox(
                          height: 15,
                        ),
                        itemCount: _userController.historyAdminModel.length);
                  }
                }))
