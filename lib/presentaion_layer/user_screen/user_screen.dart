...
import 'package:blood_test/presentaion_layer/admin_screen/chat_screen.dart';
import 'package:blood_test/presentaion_layer/user_screen/history_screen.dart';
import 'package:blood_test/presentaion_layer/user_screen/profile_screen.dart';
          ...
          children: [
            Row(
              children: [
                ...
                Text(
                  ' Hello ${_userController.userModel.name}, Welcome to Our App !',
              ...
              carouselController:controller ,
                ...
                items: [
                  ...
                  Container(
                      ...
                      clipBehavior: Clip.antiAliasWithSaveLayer,
                      child: Image(image: NetworkImage('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSGs5AmpIpHvw71kecJ_iyJuZgY6QiDksuLeEPrxyREsNW23BBn6Hzdw2YeSIXCJ9Bag4o&usqp=CAU'),fit: BoxFit.fill,)),
            ...
            Row(
              children: [
                Expanded(
                  child: GestureDetector(
                    ...
                    child: Container(
                      ...
                      child:const Icon(Icons.history,size: 150,color: ColorManger.kSecoundry,),
                    ),
                  ),
                ...
                Expanded(
                  child: GestureDetector(
                    onTap: ()async{
                      await _userController.getAdmin().whenComplete((){
                        Get.to(()=>ChatScreen(recieverId:_userController.userAdminModel.uid!));
                      });
